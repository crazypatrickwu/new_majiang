...
<head>
    ...
    <title>返佣配置-<?php echo (APP_NAME); ?></title>
...
<body class="withvernav">
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form class="stdform stdform2" action="<?php echo U('Agent/oneRebateConfig');?>" method="post">
            <div class="line-dete">
                <label>代理昵称</label>
                <span class="field">
                    <?php echo ($agentInfo['nickname']); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>手机号</label>
                <span class="field">
                    <?php echo ($agentInfo['phone']); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>微信号</label>
                <span class="field">
                    <?php echo ($agentInfo['wechat_id']); ?>
                </span>
            </div>
            <div class="line-dete">
                <label>平台返佣比例</label>
                <span class="field">
                    <input type="text" class="smallinput" name="player" value="<?php echo ($agentInfo['rebateMoneyPercent1']); ?>" />（注意：分佣比例在0到100之间，比如30%，此处填写30即可）
                </span>
            </div>
            <div class="line-dete">
                <label></label>

...
<head>
    ...
    <title>编辑代理个人信息-<?php echo (APP_NAME); ?></title>
...
<body class="withvernav">
    ...
    <div id="contentwrapper" class="contentwrapper">
        <form class="stdform stdform2" action="<?php echo U('Agent/editAgent');?>" method="post">
            <div class="line-dete">
                <label>新代理昵称</label>
                <span class="field">
            ...
            <div class="line-dete">
                <label>新代理微信号</label>
                <span class="field">
                    <input type="text" class="smallinput" value="<?php echo ($agentInfo['wechat_id']); ?>"  />
                </span>
            </div>
            <div class="line-dete">
                <label>新代理手机号</label>
                <span class="field">
                    <input type="text" class="smallinput" value="<?php echo ($agentInfo['phone']); ?>"  />
                </span>
            </div>
            <div class="line-dete">
                <label>是否锁定</label>
                <span class="field">
                    <input type="radio" name="is_lock" value="1" <?php if($agentInfo['is_lock'] == 1): ?>checked="checked"<?php endif; ?> />是
                    <input type="radio" name="is_lock" value="0" <?php if($agentInfo['is_lock'] == 0): ?>checked="checked"<?php endif; ?> />否
                </span>
            </div>
            <div class="line-dete">
                <label></label>
